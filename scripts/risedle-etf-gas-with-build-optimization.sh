...
# estimate gas
GAS=$(seth estimate --create $BYTECODE $SIG '"ETH 2x Leverage Risedle"' '"ETHRISE"' 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48 100000000)

echo "Risedle ETF with DAPP_BUILD_OPTIMIZE=1"
